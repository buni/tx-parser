...
func (m *MockTransactionRepository) BatchCreate(ctx context.Context, txs []entity.Transaction) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BatchCreate", ctx, txs)
	ret0, _ := ret[0].(error)
	return ret0
}

// BatchCreate indicates an expected call of BatchCreate.
func (mr *MockTransactionRepositoryMockRecorder) BatchCreate(ctx, txs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BatchCreate", reflect.TypeOf((*MockTransactionRepository)(nil).BatchCreate), ctx, txs)
}
