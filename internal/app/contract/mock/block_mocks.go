...
func (m *MockBlockService) GetCurrentBlock(ctx context.Context) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBlockServiceMockRecorder) GetCurrentBlock(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCurrentBlock", reflect.TypeOf((*MockBlockService)(nil).GetCurrentBlock), ctx)
}
